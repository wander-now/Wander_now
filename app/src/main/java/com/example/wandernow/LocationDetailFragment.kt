...
class LocationDetailFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.locationDetailRV.adapter = locationDetailRVAdapter
        binding.locationDetailRV.layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
